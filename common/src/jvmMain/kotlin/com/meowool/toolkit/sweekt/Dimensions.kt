package com.meowool.toolkit.sweekt.convert

import android.content.Context
import android.content.res.Resources
import android.util.DisplayMetrics
import com.meowool.toolkit.sweekt.asFloat
 ...
 */
fun Number.asDp(): Int =
  (this.asFloat() * Resources.getSystem().displayMetrics.density).roundToInt()
 ...
 * @see DisplayMetrics.density
 */
fun Number.asDp(context: Context): Int =
  (this.asFloat() * context.resources.displayMetrics.density).roundToInt()
 ...
 */
fun Number.asSp(): Int =
  (this.asFloat() * Resources.getSystem().displayMetrics.scaledDensity).roundToInt()
 ...
 * @see DisplayMetrics.scaledDensity
 */
fun Number.asSp(context: Context): Int =
  (this.asFloat() * context.resources.displayMetrics.scaledDensity).roundToInt()